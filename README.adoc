...
> This library is under deevelopment. You shouldn't use it, yet.
...
want to repeat this much everytime. Particularly because, time after time,
...
XXX where do we talk about deault. 
