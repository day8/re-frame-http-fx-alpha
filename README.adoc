...
> This library is still under development. Don't try to use it yet. + 
> *But* you can influence us with your ideas and usecases!  + 
> We use README-driven development, and this document is getting close to complete. + 
> Please have a read and open an issue with your thoughts, ideas or critique. Or, more casually, tweet me @wazound
