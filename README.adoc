...
> Don't use this library - the code is not ready. But ... + 
> We use README-Driven Development © (RDD), so you can, right now, *_influence the evolving design_* by + 
> reading this document and then openning an issue with your thoughts, ideas or unhandled usecases. + 
