...
XXX To avoid race conditions should the booleans be false in absence.  Eg: use `completed?` instead of `loading?` because "absence" (a nil) correctly matches the predacate's negative value. 
