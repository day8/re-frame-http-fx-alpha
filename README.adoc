...
The `Logical State Handlers` you write are about "doing a thing" when in a particular state. And, so, yhey implement behaviour for one part of "the machine". 
...
* the names on those lines are the *_Triggers_*
